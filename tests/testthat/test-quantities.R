...
test_that("quantities align with numeric computations.", {
  distributions <- list(
    ...
    dst_unif(-1, 1),
    dst_unif(-2, 0.8)
    # dst_beta(2,3) # Warning: "skewness" and "kurtosis_exc" errors from integral (need more rounding)
    # dst_beta(0.5,0.9),
    # dst_binom(10, 0.6)
    # dst_binom(8, 0.05),
    # dst_binom(2, 0.89),
    ...
    # dst_cauchy(0, 1) # not fixed yet 
                      # "Mean": Quantities align with numeric computations. 
                      # "Skewness": Integral did not converge. 
    # dst_weibull(1, 1)
    # dst_weibull(2, 2)
    # dst_weibull(1.1, 2.1)
    # dst_weibull(0.85, 3.55)
    # dst_f(3, 1) # "Mean": Integral did not converge.
    # dst_f(4, 1),
    # dst_f(6, 1),
    # dst_f(8, 1),
    # dst_f(8.2, 1),
    # dst_t(1) # need fixed. "Mean"
    # dst_t(2),
    # dst_t(3),
    # dst_t(4),
    # dst_t(4.2),
